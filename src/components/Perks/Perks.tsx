...
const PERKS = [
  ...
  { title: "Priority access", body: "Early access to jams, prompts, and new features." },
      ...
      <div className={styles.wrap}>
        <header className={styles.head}>
          <div>
            ...
            <p className={styles.lede}>Join now and be part of InkJam from the beginning.</p>
            <p className={styles.hand}>Founding writers leave their mark. ↴</p>
          </div>
