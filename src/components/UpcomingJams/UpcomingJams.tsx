...
const JAMS = [
  {
    ...
    blurb: "A letter, an email, a message you never hit send on.",
    meta: ["72 hours", "All genres"],
  },
  {
    month: "JUN",
    day: "07",
    title: "Small Things, Big Impact",
    blurb: "Stories about the little moments that changed everything.",
    meta: ["48 hours", "Flash Fiction"],
  },
  {
    month: "JUN",
    day: "21",
    title: "After the Rain",
    blurb: "What comes after the storm?",
    meta: ["24 hours", "Poetry / Prose"],
  },
];
